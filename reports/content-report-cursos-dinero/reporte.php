...
try{
  ...
  $datos = $reporte->cantidadDineroRecaudadoMensualEntreFechas(
    [
  ...
  $sc_logo = "images/sc_logo.png";
  $barrio_lindo = "images/barrio-lindo.png";
  $redMusical = "images/red_musical.png";
  $header = "Social Creativa";
  $footer = "Reporte generado {$fechaActual} / Administracion Social Creativa";
