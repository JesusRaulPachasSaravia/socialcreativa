        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb p-3 border bg-primary">
                <li class="breadcrumb-item active text-white" aria-current="page">
                    ...
                    <span>Reporte de afluencia de cursos</span>
                </li>
            </ol>
        </nav>
    </div>
...
function reporte() {
        ...
        if(selectMesInicial.value == 0){
            ...
            parametros.append("operacion", "pocaAfluencia");
    ...
    function generarGrafico(datos) {
        ...
        datos.sort((a, b) => a.inscritos - b.inscritos);

        datos.forEach(registro => {
            titulos.push(registro['titulo']);
            inscritos.push(registro['inscritos']);
        });
    ...
    function PDFBuild() {
        ...
        window.open(`../reports/content-report-cursos-poca-afluencia/reporte.php?${parametros}`, '_blank')
