        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb p-3 border bg-primary">
                <li class="breadcrumb-item active text-white" aria-current="page">
                    ...
                    <span>Reportes de cantidad de alumnos inscritos por cursos</span>
                </li>
            </ol>
        </nav>
    </div>
...
function reporte() {
        ...
        if(selectMesInicial.value == 0){
            ...
            parametros.append("operacion", "contarAlumnosMesAño");
    ...
    function generarGrafico(datos) {
        ...
        datos.forEach(registro => {
            ...
            ingreso.push(registro['inscritos']);
        });
    ...
    function PDFBuild() {
        ...
        window.open(`../reports/content-report-cursos-inscritos/reporte.php?${parametros}`, '_blank')
